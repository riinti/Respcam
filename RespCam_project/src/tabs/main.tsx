...
export default function Main() {
  ...
  useEffect(() => {
    ...
    try {
      if (storedFormData) {
        ...
        // 모든 속성이 존재할 경우에만 상태 업데이트
        if (parsedData.name && parsedData.disease && parsedData.allergy) {
          setFormData({
          ...
          console.warn("Some properties are missing in formData.");
        }
      }
    } catch (error) {
  ...
  const kitchendata3 = [
    { name: "empty1", value: 100 },
    { name: "empty2", value: 100 },
  ];
  const COLORS1 = ["#478F96", "#E9EDF0", "#E9EDF0", "#9084C6"];
  const COLORS2 = ["#E9EDF0", "#E9EDF0"];
              ...
              >
                <defs>
                  <linearGradient id="colorPv1" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#F8DEBD" stopOpacity={1} />{" "}
              ...
              >
                <defs>
                  <linearGradient id="colorPv2" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#E0B9BA" stopOpacity={1} />{" "}
                    <stop offset="100%" stopColor="#E0B9BA" stopOpacity={0} />{" "}
                  </linearGradient>
                </defs>
                <Area
                  type="monotone"
              ...
              >
                <defs>
                  <linearGradient id="colorPv3" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="#D0FBFF" stopOpacity={1} />{" "}
        ...
        <div style={styles.userContainer}>
          ...
          {formData.name && (
            <div>
              <div style={styles.userCard}>
                <img
                  src="../../img/icon/jasmine.png"
                  alt="{formData.name}"
                  style={styles.userImage}
                />
                <p style={styles.userName}>{formData.name}</p>
                <div style={styles.dotGroup}>
                  <div style={styles.dotNull} />
                </div>
              </div>
              <br />
              <div style={styles.graphCard}>
                ...
                <p style={styles.graphTitle}>the number of coughs</p>
                <p style={styles.graphDetail}>
                  {formData.disease},{formData.allergy}
                </p>
              </div>
            </div>
          )}
